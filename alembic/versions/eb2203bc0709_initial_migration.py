...
def upgrade():
    ...
    op.create_table(
        "instance_stats",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("mem_used_percent_max", sa.Float(), nullable=True),
        sa.Column("cpu_usage_iowait_max", sa.Float(), nullable=True),
        sa.Column("cpu_usage_idle_max", sa.Float(), nullable=True),
        sa.Column("cpu_usage_system_max", sa.Float(), nullable=True),
        sa.Column("diskio_reads_max", sa.Float(), nullable=True),
        sa.Column("cpu_usage_user_max", sa.Float(), nullable=True),
        sa.Column("disk_used_percent_max", sa.Float(), nullable=True),
        sa.Column("swap_used_percent_max", sa.Float(), nullable=True),
        sa.Column("mem_used_percent_min", sa.Float(), nullable=True),
        sa.Column("cpu_usage_iowait_min", sa.Float(), nullable=True),
        sa.Column("cpu_usage_idle_min", sa.Float(), nullable=True),
        sa.Column("cpu_usage_system_min", sa.Float(), nullable=True),
        sa.Column("diskio_reads_min", sa.Float(), nullable=True),
        sa.Column("cpu_usage_user_min", sa.Float(), nullable=True),
        sa.Column("disk_used_percent_min", sa.Float(), nullable=True),
        sa.Column("swap_used_percent_min", sa.Float(), nullable=True),
